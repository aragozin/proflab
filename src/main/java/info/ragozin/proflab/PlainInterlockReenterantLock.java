...
public class PlainInterlockReenterantLock implements Runnable {
    ...
    public static abstract class ConfigBean implements Config {
        ...
        @Override
        public String name() {
            return PlainInterlockReenterantLock.class.getName();
        }
    ...
    private final ContentionResource<ReentrantLock>[] resources; 
    ...
    public PlainInterlockReenterantLock(Config config) {
        ...
        for(int i = 0; i != resources.length; ++i) {
            resources[i] = new ContentionResource<ReentrantLock>(name + "@Res-" + i, new ReentrantLock(true));
        }
